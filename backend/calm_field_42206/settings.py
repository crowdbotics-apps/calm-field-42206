"""
Django settings for calm_field_42206 project.
...
ROOT_URLCONF = 'calm_field_42206.urls'
...
WSGI_APPLICATION = 'calm_field_42206.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_field_42206 API",
    "DESCRIPTION": "API documentation for calm_field_42206 App",
    "VERSION": "v1",
}
